-- DOORS ULTRA Premium Menu + Mobile Support
...
local isTablet = UserInputService.TouchEnabled and UserInputService.KeyboardEnabled and not UserInputService.MouseEnabled
...
mobileButton.Size = UDim2.new(0, isPhone and 65 or 70, 0, isPhone and 65 or 70)
mobileButton.Position = UDim2.new(0.05, 0, isPhone and 0.9 or 0.85, 0)
mobileButton.BackgroundColor3 = Color3.fromRGB(255, 200, 80)
mobileButton.BackgroundTransparency = 0.2
mobileButton.Image = "rbxassetid://6023428980" -- Иконка меню (шестеренка)
mobileButton.ImageColor3 = Color3.fromRGB(255, 255, 255)
mobileButton.ImageTransparency = 0.1
mobileButton.BorderSizePixel = 0
mobileButton.Visible = isMobile or isTablet
...
-- Текст на кнопке (для телефонов)
local btnText = Instance.new("TextLabel")
btnText.Size = UDim2.new(1, 0, 1, 0)
btnText.Position = UDim2.new(0, 0, 0.5, 0)
...
local btnTween = TweenService:Create(mobileButton, TweenInfo.new(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true), {
    ...
    Size = UDim2.new(0, isPhone and 70 or 75, 0, isPhone and 70 or 75)
})
btnTween:Play()

-- ===== ГЛАВНЫЙ КОНТЕЙНЕР =====
local mainFrame = Instance.new("Frame")
mainFrame.Size = UDim2.new(0, isPhone and 300 or 340, 0, isPhone and 460 or 520)
mainFrame.Position = UDim2.new(0.5, isPhone and -150 or -170, 0.5, isPhone and -230 or -260)
...
corner.CornerRadius = UDim.new(0, isPhone and 16 or 20)
...
borderCorner.CornerRadius = UDim.new(0, isPhone and 18 or 22)
borderCorner.Parent = glowBorder
glowBorder.Parent = mainFrame

local tweenInfo = TweenInfo.new(2, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true)
local glowTween = TweenService:Create(glowBorder, tweenInfo, {BackgroundTransparency = 0.2})
glowTween:Play()

-- ===== ЗАГОЛОВОК =====
local titleGradient = Instance.new("Frame")
titleGradient.Size = UDim2.new(1, 0, 0, isPhone and 50 or 60)
...
title.Text = isPhone and "✦ DOORS ✦" or "✦ DOORS PRO ✦"
...
line.Position = UDim2.new(0.05, 0, 0, isPhone and 50 or 60)
...
local function createModule(parent, yPos, labelText, icon, getter, setter, settingsCallback)
    ...
    container.Size = UDim2.new(1, 0, 0, isPhone and 45 or 50)
    ...
    settingsFrame.Position = UDim2.new(0, 0, 0, isPhone and 45 or 50)
    ...
    mainRow.Size = UDim2.new(1, 0, 0, isPhone and 45 or 50)
    mainRow.BackgroundTransparency = 1
    mainRow.Parent = container

    local label = Instance.new("TextLabel")
    label.Size = UDim2.new(isPhone and 0.4 or 0.5, 0, 1, 0)
    label.Position = UDim2.new(0, isPhone and 5 or 10, 0, 0)
    ...
    menuBtn.Size = UDim2.new(0, isPhone and 25 or 30, 0, isPhone and 25 or 30)
    menuBtn.Position = UDim2.new(isPhone and 0.62 or 0.68, 0, 0.5, isPhone and -13 or -15)
    ...
    for i = 1, 3 do
        ...
        stripe.Size = UDim2.new(0, isPhone and 14 or 16, 0, 2)
        stripe.Position = UDim2.new(0.5, isPhone and -7 or -8, 0, isPhone and 5 + (i-1) * 6 or 6 + (i-1) * 7)
    ...
    menuBtn.MouseEnter:Connect(function()
        TweenService:Create(menuBtn, TweenInfo.new(0.2), {BackgroundTransparency = 0.2}):Play()
        for _, stripe in ipairs(menuBtn:GetChildren()) do
            if stripe:IsA("Frame") then
                TweenService:Create(stripe, TweenInfo.new(0.2), {BackgroundTransparency = 0}):Play()
            end
        end
    end)
    
    menuBtn.MouseLeave:Connect(function()
        TweenService:Create(menuBtn, TweenInfo.new(0.2), {BackgroundTransparency = 0.5}):Play()
        for _, stripe in ipairs(menuBtn:GetChildren()) do
            if stripe:IsA("Frame") then
                TweenService:Create(stripe, TweenInfo.new(0.2), {BackgroundTransparency = 0.3}):Play()
            end
        end
    end)
    ...
    menuBtn.MouseButton1Click:Connect(function()
        ...
        local targetHeight = settingsOpen and (isPhone and 100 or 120) or 0
        ...
        if settingsOpen then
            TweenService:Create(stripes[1], TweenInfo.new(0.3), {
                Position = UDim2.new(0.5, isPhone and -7 or -8, 0, isPhone and 12 or 14),
                Rotation = 45
            }):Play()
            ...
            TweenService:Create(stripes[1], TweenInfo.new(0.3), {
                Position = UDim2.new(0.5, isPhone and -7 or -8, 0, isPhone and 5 or 6),
                Rotation = 0
            }):Play()
            TweenService:Create(stripes[2], TweenInfo.new(0.3), {
            ...
            TweenService:Create(stripes[3], TweenInfo.new(0.3), {
                Position = UDim2.new(0.5, isPhone and -7 or -8, 0, isPhone and 17 or 20),
                Rotation = 0
            }):Play()
        end
    ...
    toggleBg.Size = UDim2.new(0, isPhone and 45 or 55, 0, isPhone and 25 or 30)
    toggleBg.Position = UDim2.new(isPhone and 0.85 or 0.88, 0, 0.5, isPhone and -13 or -15)
    ...
    toggleCircle.Size = UDim2.new(0, isPhone and 20 or 24, 0, isPhone and 20 or 24)
    toggleCircle.Position = getter() and UDim2.new(1, isPhone and -24 or -28, 0.5, isPhone and -10 or -12) or UDim2.new(0, isPhone and 3 or 4, 0.5, isPhone and -10 or -12)
    ...
    toggleBtn.MouseButton1Click:Connect(function()
        ...
        local targetPos = newVal and UDim2.new(1, isPhone and -24 or -28, 0.5, isPhone and -10 or -12) or UDim2.new(0, isPhone and 3 or 4, 0.5, isPhone and -10 or -12)
...
-- ===== СОЗДАНИЕ МОДУЛЕЙ =====
local fullbrightModule, fullbrightSettings = createModule(mainFrame, isPhone and 55 or 65, "Fullbright", "💡", 
...
local espModule, espSettings = createModule(mainFrame, isPhone and 105 or 120, "ESP Book", "📖",
