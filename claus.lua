...
local function toggleHighlight()
    ...
    -- Добавляем подсветку всем объектам
    ...
    -- Проходим по всем частям в игре
    ...
    -- Включаем/выключаем все существующие подсветки
...
print("✅ Мод-меню загружен! Нажми F")
